...
@section('content')
    <div class="mx-20 mt-10 grid shadow">
        ...
        <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
            ...
            <div class="relative">
                <!-- User Avatar -->
                <img class="h-40 w-40 rounded-md object-cover" src=" {{ auth()->user()->avatar }}"
                ...
                <div class="mt-2 flex flex-row items-center space-x-5">
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-row items-center justify-center">
                            ...
                            <span class="font-bold text-gray-600"> {{ count(auth()->user()->posts) }}</span>
            ...
            <div class="w-100 flex flex-grow flex-col items-end justify-start">
                <div class="flex flex-row space-x-3">
                    ...
                    <a href="{{ route('posts.create') }}"
                        class="decoration-none flex rounded-md bg-blue-500 py-2 px-4 text-white transition-all duration-150 ease-in-out hover:bg-blue-600">
