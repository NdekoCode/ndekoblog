@extends('layouts.app', ['title' => 'Créer un nouvel article'])
@section('content')
    ...
    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data"
        ...
        <div class="mb-3 w-full">
            ...
            <x-input
                ...
                placeholder="Title" type="text" value="{{ old('title') }}" id="title" name="title"></x-input>
            @if ($errors->has('title'))
        ...
        <div class="mb-5 w-full">
            ...
            <textarea name="content" id="content"
                ...
                placeholder="Describe everything about this post here">{{ old('content') }}</textarea>
        ...
        <div class="mb-3 w-full">
            <x-label for="image"
                ...
                <x-input id="image" type="file" name="image" class="hidden w-full"></x-input>
            </x-label>
            @if ($errors->has('image'))
