    ...
    <div>
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                ...
                <nav class="mt-10">
                    <a class="mt-4 flex items-center bg-gray-700 bg-opacity-25 py-2 px-6 text-gray-100" href="/">
                    ...
                    <a class="mt-4 flex items-center py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                        href="/ui-elements">
                        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center">
                        <div x-data="{ notificationOpen: false }" class="relative">
                            ...
                            <div x-show="notificationOpen" @click="notificationOpen = false"
                                class="fixed inset-0 z-10 h-full w-full" style="display: none;"></div>
                            ...
                            <div class="-mx-6 flex flex-wrap">
                                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                    <div class="flex items-center rounded-md bg-white px-5 py-6 shadow-sm">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-2xl font-semibold text-gray-700">{{ count($allUsers) }}
                                            </h4>
                        ...
                        <div class="mt-8 flex flex-col">
                            <div class="-my-2 overflow-x-auto py-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div
                                            ...
                                            @forelse ($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="whitespace-no-wrap border-b border-gray-200 px-6 py-4">
                                                        ...
                                                        <div class="text-sm leading-5 text-gray-500">
                                                            Article{{ count($user->posts) > 1 ? 's' : '' }}
                                                            publié{{ count($user->posts) > 1 ? 's' : '' }}</div>
                                                    </td>
                                                    ...
                                                    <td
                                                        ...
                                                        @forelse ($user->roles()->get() as $role)
                                                            <span
                                                                class="m-1 rounded bg-green-100 p-1 font-semibold">{{ $role->name ?? '' }}
                                                            </span>
                                                        @empty<span
                                                                class="m-1 rounded bg-green-100 p-1 font-semibold">user
                                                            </span>
                                                        @endforelse
                                                    </td>
                                    ...
                                    <div class="align-center flex flex-col justify-center p-2">
                                        {{ $users->links() }}
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (count($posts) > 1)
                            <div class="container mx-auto px-4 sm:px-8">
                                <div class="py-8">
                                    ...
                                    <div class="mx-4 min-w-full overflow-x-auto px-4 py-4 sm:-mx-8 sm:px-8">
                                                ...
                                                <tbody>
                                                    @forelse ($posts as $post)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                                                <p class="whitespace-no-wrap text-gray-900"><span
